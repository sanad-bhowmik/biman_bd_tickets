...
import './Banner.css'
const Banner = ({ departureAirport, arrivalAirport, onAirportChange }) => {
  ...
  const tabContent = [
    <Tab01 departureAirport={departureAirport} arrivalAirport={arrivalAirport} onAirportChange={onAirportChange} />,
    <Tab02 />,
    <Tab03 />,
    <Tab04 />
  ];

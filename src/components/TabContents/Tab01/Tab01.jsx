...
const Tab01 = ({ departureAirport, arrivalAirport, onAirportChange }) => {
  const handleImageClick = () => {
    if (departureAirport === 'JFK' && arrivalAirport === 'DXB') {
      onAirportChange('DXB', 'DAC');
    } else {
      onAirportChange('JFK', 'DXB');
    }
  };
    ...
    <>
      ...
      >
        ...
        <div>
          ...
          <h4>Terminal, Hazrat Sha Jalal International Airport</h4>
          <h4 style={{ color: '#9DB2BF' }}>Sun, 3rd june 2022</h4>
        </div>
        <div>
          <img
            src={arrow}
            style={{ width: '180px', height: '160px', cursor: 'pointer' }}
            alt=""
      ...
      >
        <h4 style={{ textAlign: 'center', paddingTop: '5px', paddingBottom: '5px' }}>
          Change planes at International |Kuwait |KW |Kuwait(KWI), Connecting Time:04h:10m
        </h4>
      </div>
      <section
        style={{
